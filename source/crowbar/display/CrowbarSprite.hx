 ...
 * Global Sprite tools
**/
class CrowbarSprite extends FlxSprite
{
	...
	**/
	 ...
	 * @param properties	The properties to modify for this graphic, options: alpha, color, "scale.x", "scale.y".
	**/
	public function addGraphic(graphic:String, ?properties:Dynamic):CrowbarSprite
	{
	...
	**/
	public function playAnim(name:String, ?forced:Bool = false, ?reversed:Bool = false, ?frame:Int = 0):Void
	{
		...
		//this frame shit is stupid and broken so just ignore it for now
