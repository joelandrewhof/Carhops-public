...
class Paths {
	public static inline function getPath(asset:String, ?type:CrowbarAsset):String
		return getPreloadPath(asset, type);

	public static inline function getPreloadPath(asset:String, ?type:CrowbarAsset):String
	...
	public static inline function music(music:String):Sound
		return AssetHelper.getAsset('audio/mus/${music}', SOUND);
}
...
class LocalPaths {
	...
	public function getPath(asset:String, ?type:CrowbarAsset):String
		return Paths.getPreloadPath(asset, type);

	public function getPreloadPath(asset:String, ?type:CrowbarAsset):String
	...
	public function music(music:String):Sound
		return AssetHelper.getAsset('${directory}/audio/mus/${music}', SOUND);
}
