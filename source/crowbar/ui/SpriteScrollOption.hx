...
import forever.display.CrowbarSprite;
import uty.objects.CrowbarText;
...
class SpriteScrollOption extends FlxSpriteGroup
{
    ...
    public var arrowL:CrowbarSprite;
    public var arrowR:CrowbarSprite;
    ...
    public function new(?x:Int = 0, ?y:Int = 0, ?graphic:String, ?textOnTop:Bool = false, ?resize:Float)
    {
        ...
        text = new CrowbarText(0, 0, 0, "");

        arrowL = new CrowbarSprite(0, 0, 'images/menu/selArrowL');
        arrowR = new CrowbarSprite(0, 0, 'images/menu/selArrowR');
